...
export const ConectaLogo: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg viewBox="0 0 200 40" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <defs>
            <linearGradient id="logoGradient" x1="0%" y1="0%" x2="100%" y2="0%">
                <stop offset="0%" stopColor="#5BC5F2" />
                <stop offset="100%" stopColor="#2A6AB2" />
            </linearGradient>
        </defs>
        <path d="M29.93 2.93a17.07 17.07 0 100 34.14 17.07 17.07 0 000-34.14zM10.07 37.07a17.07 17.07 0 100-34.14 17.07 17.07 0 000 34.14z" fill="url(#logoGradient)"/>
        <text x="50" y="30" fontFamily="Arial, sans-serif" fontWeight="bold" fontSize="30" fill="#F4F2F2">conecta</text>
    </svg>
);

export const ConectaLogoIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <path d="M29.93 2.93a17.07 17.07 0 100 34.14 17.07 17.07 0 000-34.14zM10.07 37.07a17.07 17.07 0 100-34.14 17.07 17.07 0 000 34.14z" fill="url(#iconGradient)"/>
    </svg>
);
